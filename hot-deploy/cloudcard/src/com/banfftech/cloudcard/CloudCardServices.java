...
//		GenericValue partyGroup = (GenericValue) checkParamOut.get("partyGroup");
	...
	public static Map<String, Object> customerWithdraw(DispatchContext dctx, Map<String, Object> context) {
		...
		if(null == partyGroup){
			...
			return ServiceUtil.returnError(UtilProperties.getMessage(resourceError, "CloudCardOrganizationPartyNotFound", locale));
		}
	...
	public static Map<String, Object> modifyCardOwnerInputValidate(DispatchContext dctx, Map<String, Object> context){
		...
		if(!"FNACT_ACTIVE".equals(cloudCard.getString("statusId"))){
			...
			return ServiceUtil.returnError(UtilProperties.getMessage(resourceError, "CloudCardCanNotBeTransferred ", locale)); 
		}
