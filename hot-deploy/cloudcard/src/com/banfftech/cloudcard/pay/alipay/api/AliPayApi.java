...
public class AliPayApi {
	 ...
	 * 扫码支付通知
	 */
	public static Map<String, String> precreateNotifyUrl(HttpServletRequest request, String publicKey, String charset, String sign_type) {
		Map<String, String> map = AliPayApi.toMap(request);
		boolean flag =false;
		try {
			flag = AlipaySignature.rsaCheckV1(map, publicKey, charset, sign_type);
		} catch (AlipayApiException e) {
			e.printStackTrace();
		}
		if (!flag) {
	 ...
	 * 获取支付宝POST过来反馈信息
	 */
	public static Map<String, String> notifyUrl(HttpServletRequest request, String publicKey, String charset, String sign_type) {
		// 获取支付宝POST过来反馈信息
		Map<String, String> params = AliPayApi.toMap(request);
		boolean flag = false;
		try {
